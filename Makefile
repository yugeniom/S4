...
BOOST_URL=https://boostorg.jfrog.io/artifactory/main/release/1.65.1/source/boost_1_65_1.tar.gz
...
S4_pyext: objdir $(S4_LIBNAME)
	...
	pip3 install --upgrade --target='/content/gdrive/MyDrive/S4all/libraries' ./
